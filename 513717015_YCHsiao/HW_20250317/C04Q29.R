...
ggplot(df, aes(x = food)) +
  ...
  geom_vline(aes(xintercept = mean(food)), color="red", linetype="dashed") +
  geom_vline(aes(xintercept = median(food)), color="green", linetype="dotted") +
...
ggplot(df, aes(x = income)) +
  ...
  geom_vline(aes(xintercept = median(income)), color="green", linetype="dotted") +
...
ggplot(df, aes(x = residuals_loglog)) +
  geom_histogram(color="black", fill="blue", bins=30, alpha=0.7) +
  geom_vline(aes(xintercept = mean(residuals_loglog)), color="red", linetype="dashed") +
