...
*The p-value area is the combined area in both tails beyond t = ±0.572, and since the rejection regions are for t < −2.01 or t > 2.01, the observed t-value falls well within the acceptance region.
