...
**c.** In the linear regression model MOTEL_PCT = β₁ + β₂ COMP_PCT + e, test the null hypothesis H_0: β₂ ≦ 0 against the alternative hypothesis H_a: β₂ > 0 at the alpha = 0.01 level of significance. Discuss your conclusion. Clearly define the test statistic used and the rejection region.
