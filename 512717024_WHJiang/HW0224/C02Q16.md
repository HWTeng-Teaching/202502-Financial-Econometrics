...
$$
   ...
   where rj (the excess return on the stock) is the dependent variable, (rm - rf) (the market’s excess return) is the single explanatory variable, αj is the intercept, βj is the slope, and ej is the error term. This matches the form of a simple linear regression 
