...
**(g)** Show that the numerical values *b̂₁*, *b̂₂*, sₓ², and sᵧ² satisfy the relationship Σ*xᵢ*².
...
![image](https://github.com/user-attachments/assets/e5f723df-1ef4-4a36-827a-c2db7ec2d5c5)
