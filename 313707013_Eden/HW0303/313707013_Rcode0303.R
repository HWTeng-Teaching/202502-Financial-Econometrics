...
#d
liner_model_foodaway<- lm(lnfoodaway ~ income, data = cex5_small)
summary(liner_model_foodaway)


#e
plot(cex5_small$income,cex5_small$lnfoodaway,pch=16,cex=0.5,xlab = 'Income',ylab = 'ln(foodaway)')
abline(liner_model_foodaway, col = "red",lwd=2)

#f
resid_values <- summary(liner_model_foodaway)$resid
...
hist(cps5_small$educ,breaks = 10,xlab = "Years of education",main = 'Histogram of EDUC')
