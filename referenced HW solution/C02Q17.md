...
We estimate that an additional 100 square feet of living area will increase the expected home price by &dollar;13,402.94 holding all else constant. The estimated intercept −115.4236 would imply that a house with zero square feet has an expected price of 
