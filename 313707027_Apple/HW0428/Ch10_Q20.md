...
#### c. Compute the first-stage residuals,and add them to the CAPM model. Estimate the resulting augmented equation by OLS and test the significance of ̂$\hat{v}$ at the 1% level of significance. Can we conclude that the market return is exogenous?
