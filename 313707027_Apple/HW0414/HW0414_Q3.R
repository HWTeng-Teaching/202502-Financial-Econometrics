...
if (F_stat < F_critical_lower | F_stat > F_critical_upper) {
  cat("Reject the null hypothesis. The error variances for males and females are significantly different.\n")
} else {
  cat("Fail to reject the null hypothesis. There is no significant difference in error variances between males and females.\n")
}
...
if (NR2_2 > crit_val_2) {
  cat("Reject the null hypothesis: Evidence of heteroskedasticity with all variables.\n")
} else {
