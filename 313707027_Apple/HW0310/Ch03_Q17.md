...
$se = \sqrt{se(\hat{\beta_0})^2 + (EDUC)^2(se)(\beta_1)^2+2 \cdot EDUC \cdot cov(\beta_0,\beta_1)}$    
$\mu \pm t_{(0.025, 212)} \times se = 23.92 \pm 1.971217 \times 0.833 = [22.287, 25.553]$
...
$ se(\hat{WAGE}) = \sqrt{2.27^2 + 0.16^2 \times 16^2 - 2 \times 16 \times 0.345} = 0.8164$    
$ 95% C.I = \mu \pm z_{(0.05)} \times se = 28.6 \pm 1.96 \times 0.8164 = [27.00, 30.20]$
...
$t = \frac{-4.88-4}{3.29} = -2.6991 < t_{(212, 0.01)} = 2.3441$, which falls in the rejection region.
