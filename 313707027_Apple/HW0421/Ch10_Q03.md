...
In simple linear regression, the slope estimate is: $\theta_1 = \frac{\text{cov}(z, x)}{\text{var}(z)}$ is the slope coefficient from the first-stage regression of $x$ on $z$.
