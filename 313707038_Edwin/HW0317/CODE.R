...
elasticity <- beta_2 * income_levels / predicted1_food
elasticity

summary(model)
elasticity_lower <- conf_int[1] * income_levels / predicted1_food
elasticity_upper <- conf_int[2] * income_levels / predicted1_food

elasticity_results <- data.frame(
  INCOME = income_levels,
  Predicted_FOOD = predicted1_food,
