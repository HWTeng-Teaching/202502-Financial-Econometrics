...
$$
\hat{\sigma}_M^2 = \frac{\text{SSE}_M}{df_M} = \frac{97161.9174}{573} \approx 169.56705
$$

**GQ 檢定統計量：**

$$
GQ = \frac{\hat{\sigma}_M^2}{\hat{\sigma}_F^2} = \frac{169.56705}{144.5766} \approx 1.17285
$$
...
**結論：**  
因為 GQ 在不拒絕區間內(0.8377＜1.17285＜1.1968) ⇒ **無法拒絕 \( H_0 \)**  
=> 無足夠證據表明兩性之間的誤差變異數不同。
