...
根據第一階段回歸的 F 統計量為 56.96，MOTHERCOLL 和 FATHERCOLL 為強工具變數。然而，第二階段的 Sargan 檢定（𝑛⋅𝑅2=92.43）5%臨界值為3.84，無法拒絕所有工具變數皆有效的虛無假設，進一步進行 Hausman 檢定時，結果顯示無法拒絕 OLS 與 2SLS 估計值無系統性差異的虛無假設。
