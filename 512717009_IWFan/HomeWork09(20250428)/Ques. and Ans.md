...
NR2= 7.43855。關鍵值為 χ2(.95,1)=3.841 因此我們拒絕同質性的虛無假設。這EXPER為負數，這與我們觀察⼀致。


**(c)**

<img width="588" alt="2png" src="https://github.com/user-attachments/assets/64b5fdd4-d7d3-4eaf-b85d-afa62ca56368" />
...
⾃助標準誤差⽐穩健標準誤差稍⼩，但仍⽐通常的IV 標準誤差稍⼤。區間估計為[-0.0029761,0.1257694]。
