...
| 變數 | 預期符號 | 解釋 |
|------|----------|------|
| $ \beta_2 $ (WAGE) | $ + $ | 較高工資提高工作誘因（替代效果） |
| $ \beta_3 $ (EDUC) | $ + $ | 教育程度高者具備更佳工作機會與收入潛力 |
| $ \beta_4 $ (AGE) | $ \pm $ | 年齡可能正向影響經驗，但年長者亦可能減少工時 |
| $ \beta_5 $ (KIDSL6) | $ - $ | 幼兒照護責任增加，降低勞動供給 |
| $ \beta_6 $ (NWIFEINC) | $ - $ | 家庭其他收入增加，女性工作動機減弱（收入效果） |
