...
- \( H0: β3 ≧ 2 )，\( H1: β3 < 2 )
- \( t = \frac{1.85 - 2}{SE} = -1.414 \  p-value = 0.0785 )
...
- 差距：\( 30 \cdot \ H0: 30β2 ≧ 10  vs.  H2: 30β2 ＜ 10  \Rightarrow \ β2 ≧ 0.3333 \)
- \( t = \frac{0.42 - 0.3333}{SE} \approx 0.614 \ p-value = 0.27 \)
...
- 預測值：\( \hat{\mu} = \ β1 + \ β2\cdot30 + \ β3\cdot6 + \ β4\cdot1 = 47.58 \)
